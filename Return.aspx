<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Return.aspx.cs" Inherits="ScannerApp.Return" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <asp:TextBox ID="Quantity" runat="server" AutoPostBack="true" OnTextChanged="Quantity_TextChanged" Visible="false"></asp:TextBox>
        ...
        <asp:Button ID="btn2" runat="server" Text="" CssClass="button" Visible="false" />
