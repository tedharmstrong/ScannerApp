...
{
    public partial class RemoveCase : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string myjson = "{\"scannerID\":\"" + ScannerID.Value + "\",\"pageName\":\"RemoveFG\"}";
        ...
        protected void ScanValue_TextChanged(object sender, EventArgs e)
        {
            ...
            var url = System.Configuration.ConfigurationManager.AppSettings["APIURL"] + "RemoveFG";
