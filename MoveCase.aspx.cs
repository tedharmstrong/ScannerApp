...
{
    public partial class MoveCase : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string myjson = "{\"scannerID\":\"" + ScannerID.Value + "\",\"pageName\":\"MoveFinishedGood\"}";
        ...
        protected void ScanValue_TextChanged(object sender, EventArgs e)
        {
            ...
            var url = System.Configuration.ConfigurationManager.AppSettings["APIURL"] + "MoveFG";
